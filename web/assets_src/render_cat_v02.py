"""CATBRAIN concept art v0.2 — low-poly cat head, original placeholder art.

Headless: /Applications/Blender.app/Contents/MacOS/Blender --background \
    --python render_cat_v02.py -- <output_png>
Stdlib bpy only. All geometry procedural, symmetric, front-facing (+Y).
"""
import math
import os
import sys
...
head.name = "Head"
place(head, (0, 0, 0.95), scale=(1.08, 0.9, 0.88))
...
bpy.ops.object.light_add(type="SPOT", location=(-3.6, -3.4, 3.0))
...
# --- camera ------------------------------------------------------------------
# Face is on +Y: park the camera on +Y, pulled back for headroom.
bpy.ops.object.camera_add(location=(0, 7.2, 1.45))
